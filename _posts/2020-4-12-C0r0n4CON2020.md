...
After connecting to the [website](http://142.93.97.61:8001/) of the challenge, we observe a form with two fields, Username and PIN id. We tries several techniques, but we were not able to pass from this form. We observe the following directories through robots.txt
...
```
hash1 = keccak256(user)
hash2 = keccak256(pass)
